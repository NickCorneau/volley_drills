...
- **Pre-run flow**: all fresh setup, draft, and repeat paths create or open the singleton `SessionDraft`, keep Recommended / Passing / Serving / Setting inline on Setup where applicable, then continue directly to Safety. Safety remains readiness-only.
