 ...
 * - "Repeat full plan" -> /safety with a rebuilt full-plan draft
 *   (2026-04-22 one-tap Repeat; previously went to /setup?from=repeat)
 * - "Repeat shorter version (M min)" -> /safety with partial draft
 */
...
describe('HomeScreen: Repeat on ended-early (C-5 Unit 3)', () => {
  ...
  it('Repeat shorter version -> /safety with a partial draft (2 blocks, not 3)', async () => {
