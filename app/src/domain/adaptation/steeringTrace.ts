...
// D158 (2026-06-12): the KTD7 Home repeat note (`REPEAT_DRIFT_NOTE` /
// `repeatPlanDrifted`) was retired with the Repeat affordance it
// qualified. The Safety steering trace above is unaffected.
