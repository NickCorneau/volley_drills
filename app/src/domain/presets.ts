...
export const PRESETS: PresetDefinition[] = [
  ...
  },
  {
    ...
    description: 'One serves, one passes — trade roles and keep score.',
    totalMinutes: 15,
  },
]
...
const PRESET_BLOCK_BUILDERS: Record<string, () => PlannedBlock[]> = {
  'wall-pass': () => [
    plannedBlockFromVariant('wall-pass-warmup', 'warmup', 'd01', 'd01-solo', 3, true),
    plannedBlockFromVariant('wall-pass-main', 'main_skill', 'd24', 'd24-solo', 6, false),
    plannedBlockFromVariant('wall-pass-cooldown', 'wrap', 'd25', 'd25-solo', 3, true),
  ],
  'open-sand': () => [
    plannedBlockFromVariant('open-sand-warmup', 'warmup', 'd01', 'd01-solo', 3, true),
    plannedBlockFromVariant('open-sand-main', 'main_skill', 'd05', 'd05-solo', 6, false),
    plannedBlockFromVariant('open-sand-cooldown', 'wrap', 'd25', 'd25-solo', 3, true),
  ],
  'partner-pass': () => [
    plannedBlockFromVariant('partner-pass-warmup', 'warmup', 'd03', 'd03-pair', 3, true),
    plannedBlockFromVariant('partner-pass-main', 'main_skill', 'd04', 'd04-pair', 9, false),
    plannedBlockFromVariant('partner-pass-cooldown', 'wrap', 'd25', 'd25-solo', 3, true),
  ],
  'solo-serving': () => [
    plannedBlockFromVariant('solo-serving-warmup', 'warmup', 'd01', 'd01-solo', 3, true),
    plannedBlockFromVariant('solo-serving-main', 'main_skill', 'd22', 'd22-solo', 6, false),
    plannedBlockFromVariant('solo-serving-cooldown', 'wrap', 'd25', 'd25-solo', 3, true),
  ],
  'serve-receive': () => [
    plannedBlockFromVariant('serve-receive-warmup', 'warmup', 'd03', 'd03-pair', 3, true),
    plannedBlockFromVariant('serve-receive-main', 'main_skill', 'd18', 'd18-pair', 9, false),
    plannedBlockFromVariant('serve-receive-cooldown', 'wrap', 'd25', 'd25-solo', 3, true),
  ],
}
