      ...
      return (
        <div className="flex min-h-[100dvh] flex-col items-center justify-center gap-4 p-4 text-center">
          ...
          <button
            ...
            className="min-h-[54px] rounded-focal bg-accent px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-pressed active:bg-accent-pressed"
          >
            Back to home
          </button>
        </div>
