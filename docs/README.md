...
| `brainstorms/` | requirements and lightweight PRDs that define what to build before planning how; includes generated-diagnostics addenda for decision-debt compression, dynamic surface sentinels, redistribution causality receipts, and receipt-backed proposal admission | turning selected ideas into product or workflow requirements |
...
| `archive/` | completed or superseded historical docs moved out of active routing, preserving their original family under `docs/archive/<family>/` | looking up implementation history that is no longer an active plan or requirement |
