...
The v0b Starter Loop in `app/` implements the current M001 review path, with post-`D133` drill-grain capture handled on `/run/check` before Transition. Older v0a deviations are preserved in `docs/research/2026-04-12-v0a-runner-probe-feedback.md` for retrospective context.
