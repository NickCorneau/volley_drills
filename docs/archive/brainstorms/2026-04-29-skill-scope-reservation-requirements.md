...
stage: validation
type: requirements
summary: "SUPERSEDED 2026-04-30. The intermediate Track 4 replacement in docs/brainstorms/2026-04-30-pre-run-simplification-requirements.md was compressed into the terminal successor docs/plans/2026-04-30-001-feat-pre-run-simplification-plan.md, which owns the shipped JSDoc/no-schema-change policy. Originally specced a docs+types reservation PR (add 'attack' to the SkillFocus union, add scenario? to DrillVariant, author a research note) so future content could land without a schema bump. Skill-correlation insight and cluster pairing remain valid as future-state design context; only the implementation cost is deferred."
authority: "Historical. Terminal successor is docs/plans/2026-04-30-001-feat-pre-run-simplification-plan.md; it owns the shipped Track 4 JSDoc policy and no-schema-change outcome."
...
> **Superseded 2026-04-30.** The intermediate Track 4 replacement in `docs/brainstorms/2026-04-30-pre-run-simplification-requirements.md` was compressed into the terminal successor `docs/plans/2026-04-30-001-feat-pre-run-simplification-plan.md`, which owns the shipped JSDoc/no-schema-change policy. No code under this doc was implemented; it is preserved as historical record of the analysis.
...
- Tier 1c `docs/archive/plans/2026-04-29-001-feat-tune-today-focus-picker-plan.md` lands first or in parallel; this slice does not block on it but must respect its tests.
