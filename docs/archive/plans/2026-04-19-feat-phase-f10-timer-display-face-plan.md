...
- `docs/archive/plans/2026-04-19-feat-phase-f9-inter-self-host-plan.md` — F9 established the Fontsource + Vite + workbox precache pattern this plan reuses for the mono face.
- `docs/archive/plans/2026-04-19-feat-phase-f8-typography-foundation-plan.md` — F8 explicitly enumerated F10 as the mono-swap follow-on.
...
- `docs/archive/plans/2026-04-19-feat-phase-f9-inter-self-host-plan.md` — F9 established the Fontsource / Vite / precache pattern reused here.
