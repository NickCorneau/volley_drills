...
depends_on:
  ...
  - docs/archive/plans/2026-04-19-feat-phase-f7-post-manual-testing-polish-plan.md
...
- `docs/archive/plans/2026-04-19-feat-phase-f7-post-manual-testing-polish-plan.md` — the most recent calm-pass plan this sits alongside. F7 already touched `RpeSelector` for chip-grid alignment; F8's anchor-size change rides the same file.
...
- `docs/archive/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` — first calm-pass plan in the series.
- `docs/archive/plans/2026-04-19-feat-phase-f7-post-manual-testing-polish-plan.md` — most recent calm-pass plan; shared `RpeSelector` touch-point with F8 Unit 4.
