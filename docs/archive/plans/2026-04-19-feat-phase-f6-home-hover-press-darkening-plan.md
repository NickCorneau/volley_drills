...
- `docs/archive/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` through `-f5-copy-polish-plan.md` — the surrounding calm pass; F6 adds tactile interaction state to the visual direction F1–F5 established.
