...
- `docs/archive/plans/2026-04-19-feat-phase-f8-typography-foundation-plan.md` — F8 killed the uppercase-tracked-wider eyebrow pattern; F12 extends the same sentence-case rule to titles and multi-word buttons.
...
- `docs/archive/plans/2026-04-19-feat-phase-f8-typography-foundation-plan.md` — established the sentence-case direction for eyebrow labels; F12 extends to titles and buttons.
