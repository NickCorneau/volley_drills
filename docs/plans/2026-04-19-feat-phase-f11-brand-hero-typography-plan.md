...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` — F1 correctly downscaled the wordmark to avoid the launch-splash reading; F11 respects that constraint and calibrates the correction.
- `docs/plans/2026-04-19-feat-phase-f8-typography-foundation-plan.md` — F8 added the CompleteScreen page-level `<h1>`; F11 is the follow-on that gives the verdict `<h2>` appropriate display weight.
...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` — wordmark size constraint that F11 respects.
- `docs/plans/2026-04-19-feat-phase-f8-typography-foundation-plan.md` — CompleteScreen page-level `<h1>` this plan's verdict sits beneath.
