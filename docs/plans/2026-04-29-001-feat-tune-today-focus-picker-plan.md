...
- Modify: `docs/plans/2026-04-28-tier-1c-prepay-and-catalog-audit.md` (update Stream 1 status note from "must be rewritten before implementation" to "implementation owned by `docs/plans/2026-04-29-001-feat-tune-today-focus-picker-plan.md`")
...
- Modify: `docs/plans/2026-04-28-tier-1c-prepay-and-catalog-audit.md` — flip Stream 1's status block from "implementation owned by this plan" (set in U0) to "implemented per `docs/plans/2026-04-29-001-feat-tune-today-focus-picker-plan.md`"; mark U1-U5 as historical/landed-by-supersession.
