...
- **Upstream:** [docs/plans/2026-04-17-feat-phase-c1-review-contract-plan.md](2026-04-17-feat-phase-c1-review-contract-plan.md) (A7 softBlock helper + A8 discarded-resume filter + A9 universal landing), [docs/plans/2026-04-17-feat-phase-c3-two-screen-onboarding-plan.md](2026-04-17-feat-phase-c3-two-screen-onboarding-plan.md) (FirstOpenGate runs before Home)
- **Downstream:** [docs/plans/2026-04-17-feat-phase-c5-repeat-path-plan.md](2026-04-17-feat-phase-c5-repeat-path-plan.md) (implements the LastComplete handlers C-4 defines)
