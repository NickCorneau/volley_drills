...
depends_on:
  ...
  - docs/plans/2026-04-19-feat-phase-f4-complete-forward-hook-plan.md
...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` through `-f4-complete-forward-hook-plan.md` — the surrounding calm pass; F5 completes the "consistent, restrained copy" side of the direction.
