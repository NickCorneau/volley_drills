...
- `docs/plans/2026-04-19-feat-phase-f-d91-validity-hardening-plan.md` — the parent Phase F work this sits alongside; Phase F1 is a quiet follow-on that does not change any Phase F contract.
