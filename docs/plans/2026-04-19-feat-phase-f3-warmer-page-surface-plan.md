...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` and `docs/plans/2026-04-19-feat-phase-f2-shared-focal-surface-plan.md` — the card-side work that F3 completes.
