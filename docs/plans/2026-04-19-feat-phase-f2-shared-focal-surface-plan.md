...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` — the original calm pass; F2 generalises its local constant.
...
- `docs/plans/2026-04-19-feat-phase-f1-home-calm-pass-plan.md` — parent plan; F2 extracts F1's local constant.
