...
| **Serving 2.3 Deep Serve Practice** | Activated as `d53` (2026-06-21) + Tier 1 source (cues) | Deep-serve trajectory cue ("must travel high") feeds `d34 Deep Rainbow Serves` in Tier 1 Unit 3; the deep-zone groove also authored as serve rung 1 sibling `d53 Deep Serve Practice` in the M002.2 roster-depth wave. Provenance: `docs/plans/2026-06-21-002-feat-roster-depth-source-backed-drills-plan.md`. |
...
| **Setting 4.1 Set and Move** | Activated as `d56` (2026-06-21) | Beginner setting-while-moving; authored as set rung 2 sibling `d56 Set and Move` (continuous set along a slow line, distinct from `d41`'s stationary rhythm) in the M002.2 roster-depth wave. Provenance: `docs/plans/2026-06-21-002-feat-roster-depth-source-backed-drills-plan.md`. |
| **Setting 4.2 / 4.3 / 4.4 High Rep Setting (Triangle / Large Groups / Triangle-Advanced)** | Tier 1 equivalent + partial source for `d57` (2026-06-21) | Covered by `d43 Triangle Setting` and `d44 Triangle Setting Off Toss`; 4.4's changing-target rep load (reduced, plus BAB footwork-for-setting) also feeds set rung 3 sibling `d57 Moving Target Setting`. |
