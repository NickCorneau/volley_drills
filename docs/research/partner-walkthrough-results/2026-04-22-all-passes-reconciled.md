...
- ✅ Screen Wake Lock on active session (item 17). [2026-04-24 hook hardening — re-acquires on visibility return, releases on explicit pause / unmount, graceful fallback when unsupported]
