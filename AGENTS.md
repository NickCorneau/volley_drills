...
- **Active milestone**: `M002` Weekly Training Home (a milestone **series**, re-scoped + renamed from "Weekly Confidence Loop" 2026-06-03 per `D149`; per `D124`), status `active / stage: build` — M001 closed 2026-05-27 by founder executive call (`D147`). The series is in flight: M002.1 Thin-Spine + Visible Adaptation shipped 2026-06-04/05 (`D150`–`D152`), with pull-forwards `D153`–`D160` (stress substrate, session truth, Home covenant, stress visibility, shibui polish, steering-everywhere + catalog-wide ladders) landed through 2026-06-12; M002.2 Stress Ladders + Technique-How Depth is the next spine milestone. The series (progression spine M002.1→M002.2→M002.3 + goals/roster/attack tracks + Phase 1.5 handoff) is scoped at milestone level in `docs/brainstorms/2026-06-03-m002-thin-spine-and-milestone-series-requirements.md`; each milestone is planned 1-by-1
